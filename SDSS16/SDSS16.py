# -*- coding: utf-8 -*-
"""
Created on Mon Aug 10 10:34:06 2020
...
dataframe = pd.read_csv("SkyServer.csv",sep = ",")
...
X = dataframe.drop(["objid","class"],axis="columns")
y = dataframe["class"]
...
neuralNetworkClassifier.fit(X_trainNorm,y_train,epochs=10,batch_size=16)
